...
var (
	...
	QueryGetByCharacterDataId = `SELECT * FROM proficiency INNER JOIN character_proficiency ON character_proficiency.proficiency_id = proficiency.proficiency_id WHERE character_proficiency.character_id = ?;`
